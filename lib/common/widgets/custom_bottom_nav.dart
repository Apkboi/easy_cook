            ...
            Expanded(
              child: InkWell(
                ...
                child: NavItem(
                  ...
                  selectedIconColor: widget.selectedIconColor ?? Theme
                      .of(context)
                      .colorScheme
                      .primary,
          ...
          child: Theme(
            data: ThemeData(
                iconTheme: IconThemeData(
                    color: widget.isSelected ? widget.selectedIconColor : widget
                        .unselectedIconColor)),

            child: AnimatedCrossFade(
                firstChild: widget.navItem.icon,
                secondChild: widget.navItem.selectedIcon!,
                crossFadeState: widget.isSelected &&
                    widget.navItem.selectedIcon != null
